...
export function ReceivablesPage() {
  ...
  return <div className="page-stack"><PageHeader eyebrow="Comercial" title="Cuentas por cobrar" description="Vista operativa derivada por el backend; incluye ventas registradas y de mostrador." />
    <HelpNote title="Qué es esto">Es lo que <strong>tus clientes te deben a ti</strong>. Aparecen aquí las ventas ya confirmadas que todavía no están pagadas por completo, con o sin cliente registrado. El &quot;pendiente&quot; es el total de la venta menos lo que el cliente ya pagó. Una venta se marca <strong>vencida</strong> cuando pasó su fecha de pago y aún debe dinero. Registrar el cobro se hace desde el detalle de cada venta.</HelpNote>
