...
export function CashRegistersPage() {
  ...
  return <div className="page-stack">
    <PageHeader eyebrow="Caja" title="Cajas" description="Los puntos físicos donde se guarda y cuenta el efectivo: mostrador, bodega, etc." actions={hasPermission("cash-registers.manage") ? <Link className="button button--primary" to="/app/cash/registers/new">Nueva caja</Link> : undefined} />
...
function CashRegisterEditor({ id, initial }: { id?: string; initial?: CashRegister }) {
  ...
  return <div className="page-stack"><PageHeader eyebrow="Caja" title={id ? "Editar caja" : "Nueva caja"} description="Desactivar una caja no borra sus turnos ni sus movimientos anteriores." />
